...
//ddvar bot = new Bot('t44uk7pz', 'training', 'http://vind-legacy.thegrid.red'); //Put your bot's code here and change training to Arena when you want to fight others.
...
Bot.prototype.botBrain = function() {
    return new Promise(function(resolve, reject) {
        ...
        /**
         * Finds an owned mine and stores it in ownedMine 
         */
        ...
        /**
         * If for whateveer reason, no task gets set, it'll just walk randomly
         */ 
        if (task === "none") {
        ...
        /**
         * This makes the bot find all free mines and goes to them.
         */ 
        ...
        /**
         * If the bot's health is low, this will send them to the tavern
         */ 
        else if (task === "health") {
